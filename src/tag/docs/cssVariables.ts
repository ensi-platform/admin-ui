/** Tag CSS variables from semantic tokens (--aui-tag-*). */
export const docsCssVariables = `/* CSS variables — Tag (--aui-tag-*) */
--aui-tag-bg-primary: var(--aui-surface-bg-muted); /* primary fill */
--aui-tag-fg-primary: var(--aui-page-fg-primary); /* primary foreground */
--aui-tag-fg-muted: var(--aui-page-fg-muted); /* muted foreground */
--aui-tag-border-primary: var(--aui-surface-border-primary); /* primary border */
