...
- `labels`: `Partial<IAuiLabels>` — merge поверх EN-дефолтов (`close`, `clear`, `loading`, `loadingSuggestions`, `noSuggestions`, `suggestionsError`, `moreSelected`, `openCalendar`, `pageSize`, `paginationNext`, …)
