/** ActionPopup CSS variables from semantic tokens (--aui-modal-*). */
export const docsCssVariables = `/* CSS variables — ActionPopup (--aui-modal-*) */
--aui-modal-overlay-bg-primary: var(--aui-overlay-bg-primary); /* overlay fill */

--aui-modal-bg-primary: var(--aui-surface-bg-elevated); /* primary fill */
--aui-modal-fg-primary: var(--aui-page-fg-primary); /* primary foreground */
--aui-modal-fg-muted: var(--aui-page-fg-muted); /* muted foreground */
--aui-modal-border-primary: var(--aui-surface-border-primary); /* primary border */

--aui-modal-shadow: var(--aui-shadow-md); /* box shadow */

--aui-modal-radius-md: var(--aui-control-radius-lg); /* md radius */
--aui-modal-radius-fullscreen: var(--aui-radius-0); /* fullscreen radius */
--aui-modal-w-sm: 400px; /* width sm */
--aui-modal-w-md: 560px; /* width md */
--aui-modal-w-lg: 720px; /* width lg */
--aui-modal-max-h: min(90vh, 800px); /* max-height */
...
--aui-modal-close-border-focus: var(--aui-control-border-focus); /* close button border focus */

--aui-modal-z: var(--aui-z-modal); /* z-index */

--aui-modal-duration-normal: var(--aui-control-duration-normal); /* transition duration (normal) */
--aui-modal-ease-out: var(--aui-control-ease-out); /* transition easing */`;
