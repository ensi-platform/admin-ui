/** Switch CSS variables from semantic tokens (--aui-switch-*). */
export const docsCssVariables = `/* CSS variables — Switch (--aui-switch-*) */
--aui-switch-track-bg-primary: var(--aui-surface-bg-muted); /* track bg primary */
--aui-switch-track-bg-selected: var(--aui-control-bg-brand); /* track bg selected */

--aui-switch-thumb-bg-primary: var(--aui-white); /* thumb bg primary */
--aui-switch-thumb-bg-selected: var(--aui-white); /* thumb bg selected */

--aui-switch-fg-primary: var(--aui-page-fg-primary); /* primary foreground */
...
--aui-switch-duration-fast: var(--aui-control-duration-fast); /* transition duration (fast) */
--aui-switch-ease-out: var(--aui-control-ease-out); /* transition easing */`;
